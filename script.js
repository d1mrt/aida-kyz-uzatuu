...
const translations = {
  ky: {
    metaDescription: "Кыз узатуу мааракеси үчүн кооз чакыруу сайты: жооп берүү, сүрөт маанайы жана конок маалыматтары.",
    ...
    brandSubtitle: "Аиданын маарекеси",
    navDetails: "Маалымат",
    navMoments: "Көз ирмемдер",
    navRsvp: "Жооп берүү",
    heroEyebrow: "2026-жылдын 22-июлу - Ош шаары",
    heroTitle: "Аида",
    heroSubtitle: "Кыз Узатуу",
    heroLead: "Бул күн биз үчүн өзгөчө маанилүү. Биз бул кубанычтуу көз ирмемди эң жакын, сүйүктүү адамдардын жана досторубуздун курчоосунда өткөргүбүз келет.\n\nСиздерди кызыбыздын Аида Кыз Узатуу тоюна чакырганыбызга абдан кубанычтабыз!",
    ...
    venueCardText: "Тумар кафеси, Ош шаары. Кире бериште үй-бүлөлүк тосуп алуу уюштурулат.",
    ...
    countMinutes: "Мүнөт",
    countSeconds: "Секунд",
    calendarPanelKicker: "Той салтанаты",
    calendarPanelDate: "22-июль, саат 18:00",
    ...
    formGuestCountLabel: "Конок саны",
    ...
    locationTitle: "Тумар кафеси, Ош шаары",
    ...
    honoree: "Аида Кыз Узатуу",
    eventLocation: "Ош шаары, Кыргызстан",
    ...
    waName: "Аты-жөнү",
    waGuestCount: "Конок саны",
    waAttendance: "Келүү мүмкүнчүлүгү",
    waMessage: "Каалоо-тилек",
    attendanceLabels: { yes: "келет", no: "келе албайт" }
  },
  ru: {
    metaDescription: "Элегантный сайт-приглашение на кыз узатуу: детали, галерея и ответ через WhatsApp.",
    ...
    navMoments: "Моменты",
    navRsvp: "Ответить",
    heroEyebrow: "22 июля 2026 - город Ош",
    heroTitle: "Аида",
    heroSubtitle: "Кыз Узатуу",
    heroLead: "Этот день имеет для нас особое значение. Мы хотим провести этот радостный момент в кругу самых близких, любимых людей и друзей.\n\nМы очень рады пригласить вас на торжество «Аида Кыз Узатуу»!",
    ...
    venueCardText: "Кафе Тумар, город Ош. У входа будет организована семейная встреча гостей.",
    ...
    countMinutes: "Минут",
    countSeconds: "Секунд",
    calendarPanelKicker: "День торжества",
    calendarPanelDate: "22 июля, 18:00",
    ...
    formGuestCountLabel: "Количество гостей",
    ...
    waName: "Имя",
    waGuestCount: "Количество гостей",
    waAttendance: "Участие",
    waMessage: "Пожелание",
    attendanceLabels: { yes: "придет", no: "не сможет прийти" }
  },
  en: {
    metaDescription: "An elegant Kyz Uzatuu invitation website with event details, gallery, and WhatsApp RSVP.",
    ...
    navMoments: "Moments",
    navRsvp: "RSVP",
    heroEyebrow: "22 July 2026 - Osh city",
    heroTitle: "Aida",
    heroSubtitle: "Kyz Uzatuu",
    heroLead: "This day is especially meaningful to us. We want to share this joyful moment surrounded by our closest, beloved people and friends.\n\nWe are very happy to invite you to the Aida Kyz Uzatuu celebration!",
    ...
    venueCardText: "Tumar Cafe, Osh city. A family welcome will be arranged at the entrance.",
    ...
    calendarPanelKicker: "Celebration Day",
    calendarPanelDate: "22 July, 18:00",
    ...
    formGuestCountLabel: "Guest count",
    ...
    waName: "Name",
    waGuestCount: "Guest count",
    waAttendance: "Attendance",
    waMessage: "Wish",
    attendanceLabels: { yes: "will attend", no: "cannot attend" }
  },
  tr: {
    metaDescription: "Kız uzatuu kutlaması için zarif davetiye sitesi: detaylar, galeri ve WhatsApp yanıtı.",
    ...
    navMoments: "Anlar",
    navRsvp: "Yanıt",
    heroEyebrow: "22 Temmuz 2026 - Oş şehri",
    heroTitle: "Aida",
    heroSubtitle: "Kız Uzatuu",
    heroLead: "Bu gün bizim için çok özel ve anlamlı. Bu mutlu anı en yakın, sevdiğimiz insanlar ve dostlarımızla geçirmek istiyoruz.\n\nAida Kız Uzatuu törenine sizi davet etmekten büyük mutluluk duyuyoruz!",
    ...
    venueCardText: "Tumar Kafesi, Oş şehri. Girişte aile karşılaması yapılacaktır.",
    ...
    countMinutes: "Dakika",
    countSeconds: "Saniye",
    calendarPanelKicker: "Kutlama Günü",
    calendarPanelDate: "22 Temmuz, 18:00",
    momentsKicker: "Anlar",
    ...
    formGuestCountLabel: "Konuk sayısı",
    ...
    waName: "Ad soyad",
    waGuestCount: "Konuk sayısı",
    waAttendance: "Katılım",
    waMessage: "Dilek",
    attendanceLabels: { yes: "katılacak", no: "katılamaz" }
  }
};
...
function buildWhatsAppMessage(payload) {
  ...
  return [
    ...
    `${t("waGuestCount")}: ${payload.guestCount}`,
